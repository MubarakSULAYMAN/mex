<template>
    <div>
        ...
        <div class="p-4 md:p-12">
            <div v-if="expenses.length > 0">
                ...
                <table class="table-fixed shadow-lg bg-white border-collapse border hover:border-purple-700 text-xs md:text-base md:font-normal mb-36">
                    ...
                    <tr class="border border-collapse even:border-purple-700 font-normal md:font-medium text-center transform transition duration-500 ease-in-out hover:bg-purple-500 hover:text-white"
                        ...
                        <td class="border p-1 md:px-8 md:py-4"> {{ ++index }}
                        </td>
            ...
            <div class="p-3 sm:p-6 text-lg sm:text-5xl md:text-9xl text-purple-700 bg-transparent shadow-2xl rounded-3xl text-center transform transition duration-1000 ease-in-out hover:shadow-none hover:text-white hover:bg-purple-700" v-if="expenses.length < 1 && loading === false"> No Record Available
            </div>
        </div>
    </div>
</template>
