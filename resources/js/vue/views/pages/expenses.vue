<template>
    <div>
        ...
        <button
            ...
            @click="$router.push('expenses/modify')">
            <font-awesome-icon class="hover:text-yellow-700 mr-2" :icon="['fas', 'file-invoice']" />
            Modify
        </button>

        <div class="p-12">
            <p class="group text-purple-700 font-light text-xl inline-block"> Here are the existing records. <span class="text-xs font-medium opacity-0 group-hover:opacity-100">Click the button below
                    to modify.</span> </p>
            <table class="table-fixed shadow-lg bg-white border-collapse border hover:border-purple-700">
                ...
                <tr class="border border-collapse even:border-purple-700 font-medium text-purple-700 text-center transform transition duration-500 ease-in-out hover:bg-purple-500 hover:text-white">
                    ...
                    <td class="border px-8 py-4"> Some superstory about fantasy. </td>
